...
public class MergeArray {
    public static void main(String[] args) {
        int[] array1 = ArrayIO.inputInt(3, 50, "Nhập số lượng phần tử của mảng 1: ", "Nhập phần tử thứ ");
        int[] array2 = ArrayIO.inputInt(3, 50, "Nhập số lượng phần tử của mảng 2: ", "Nhập phần tử thứ ");
